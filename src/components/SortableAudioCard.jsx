...
/**
 * A sortable pinned audio card for drag-and-drop reordering.
 * Wraps the AudioCard component with drag functionality and custom click handling
 * to prevent navigation when a drag/drop occurs.
 */
function SortableAudioCard({
  audio,
  onEdit,
  onDelete,
  onTogglePin,
  ...
  const handleClick = (e) => {
    ...
    // Navigate to the listen page for a plain click (no drag)
    navigate(`/listen/${audio.short_id}`)
  }
